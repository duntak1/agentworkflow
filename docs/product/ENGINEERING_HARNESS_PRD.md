...
| 对象 | 说明 |
|------|------|
| Project | 本地或主流代码托管平台项目，支持单项目、多项目、前后端分离 |
...
1. 选择项目类型：GitHub、GitLab、Bitbucket、Gitee、GitCode、Gitea、Forgejo、GitLab CE、Gerrit、阿里云云效 Codeup 或本地 Git 仓库。
2. 选择构建目标：前端 / 后端 / 前后端 / 多项目。
3. 配置项目路径、remote repository URL、同步中心路径。
