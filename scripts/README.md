...
| [`install-aw-adapters.sh`](./install-aw-adapters.sh) | IDE / Agent 适配：`aw adapters --all`（Claude/Codex/Copilot/Cursor/Windsurf/Cline/Continue/QoderWork/TraeIDE/Lingma/OpenClaw/qclaw），`aw adapters --china` 安装国产 / 龙嘉组合 |
