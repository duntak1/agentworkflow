...
| PM dispatch/dashboard | `aw pm dispatch --write`, `aw pm assignments --role frontend|admin|backend`, and `aw pm dashboard --write` maintain three-side task boards and PM-readable progress |
