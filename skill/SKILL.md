...
| Harness control | `aw gate`, `aw contract`, `aw vcs`, `aw agents claim`, `aw score`, and `aw recover` make hooks, API contracts, PR/MR/CRs, agent locks, delivery scoring, and recovery checkable |
