...
- Add token-budget mode: lean runtime Skill instructions, staged context reading, tighter default AT-T budgets, DSL/Plan split-reading guidance, and sync inbox summary-first rules.
